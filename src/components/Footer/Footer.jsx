      ...
      <div className="w-full max-w-none mx-0 grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="col-span-1">
          ...
          <div className="flex items-center mb-2">
            ...
            <p className="text-xl">+91 7983131615</p>
          </div>
          <div className="flex items-center mt-5">
            <FaMapMarkerAlt className="mr-2" />
            <p className="text-lg">Qdore Home <br /> Quality Collection Inc <br /> Lakri Fazalpur, Delhi Road <br /> Moradabad (UP) 244001, India</p>
          </div>
          <div className="flex items-center mt-5">
            <FaEnvelopeSquare className="mr-2" />
            <p className="text-lg">admin@qdorehome.com</p>
          </div>
        </div>
