      ...
      <div className="container mx-auto mt-5 mb-12 px-4">
        <div className="flex flex-col lg:flex-row justify-center mb-12 space-y-10 lg:space-y-0 lg:space-x-10">
          <div className="text-center lg:w-1/3">
            <img src={WhoWeAreImg} alt="Who We Are" className="mx-auto w-full lg:w-3/4" />
            <h2 className="text-3xl lg:text-4xl font-lora text-center font-bold bg-heading-gradient bg-clip-text text-transparent">Who we are</h2>
          ...
          <div className="text-center lg:w-1/3">
            <img src={WhatWeDoImg} alt="What We Do" className="mx-auto w-full lg:w-3/4" />
            <h2 className="text-3xl lg:text-4xl font-lora text-center font-bold bg-heading-gradient bg-clip-text text-transparent">What we do</h2>
            <p className="text-lg lg:text-base">
              At Qdore Home, we believe in creating spaces achieving functionality through our products in various product categories. With the belief in “Made in India” campaign, all our products are designed and manufactured by our own team of designers & craftsmen at our in-house manufacturing unit.
            </p>
          </div>
          <div className="text-center lg:w-1/3">
            <img src={WhyDifferentImg} alt="Why We're Different" className="mx-auto w-full lg:w-3/4" />
            <h2 className="text-3xl lg:text-4xl font-lora text-center font-bold bg-heading-gradient bg-clip-text text-transparent">Why we're different</h2>
            <p className="text-lg lg:text-base">
              At Qdore Home, we manufacture all our products at our own production facility located in Moradabad, UP (Brass City of India), allowing us to achieve spectacular quality at the best possible prices. Our Direct-to-Consumer model enables meticulous attention to detail, using premium materials.
            </p>
          </div>
        </div>
        <div className="text-center mb-20 mt-20">
          <h1 className="text-5xl font-lora text-center font-bold bg-heading-gradient bg-clip-text text-transparent">Why Choose Qdore Home?</h1>
        </div>
        <div className="flex flex-wrap justify-center">
          ...
          <div
            ...
            onMouseLeave={handleMouseLeave}
          >
            <FaDollarSign className="text-5xl mb-4 mx-auto" />
        ...
        <div className="text-center mb-20 mt-20">
          <h1 className="text-5xl font-lora text-center font-bold bg-heading-gradient bg-clip-text text-transparent ">Message from the Founder</h1>
        </div>
        <div className="relative  rounded-lg mb-12 h-full">
          <div className="relative flex flex-col md:flex-row items-center md:items-center h-full">
            ...
            <div className=" md:w-1/2 md:pl-8 flex flex-col justify-center h-full">
              <h2 className="text-5xl font-roboto font-semibold mb-12">Rmneek Sikka</h2>
        ...
        <div className="text-center mb-20 mt-20">
          <h1 className="text-5xl font-lora text-center font-bold bg-heading-gradient bg-clip-text text-transparent">Our Vision and Mission</h1>
        </div>
        <div className="flex flex-wrap justify-center">
          <div
            className="bg-white m-5 mb-8 p-6 rounded-lg shadow-lg w-80 hover:shadow-2xl transform hover:-translate-y-2 transition-all animated-icon"
        ...
        <div className="text-center mb-20">
          <h1 className="text-5xl font-lora text-center font-bold bg-heading-gradient bg-clip-text text-transparent">Proudly Made in India</h1>
        </div>
