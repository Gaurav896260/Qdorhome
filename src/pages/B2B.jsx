    ...
    <div className='min-h-screen flex flex-col bg-white dark:bg-gray-900 dark:text-white'>
      ...
      <div className="container mx-auto mt-5 mb-12">
        <div className="text-center mb-5 mt-5">
          <h1 className="text-5xl font-lora text-center font-bold bg-heading-gradient bg-clip-text text-transparent">Welcome to Qdore Home B2B</h1>
        </div>
        <div className="flex justify-between items-start mb-12">
          <div className="flex justify-between items-start mb-12">
            {/* Left paragraph with 40% width */}
            <div className="w-2/5 pr-10">
              <p className="mt-5 text-black text-2xl font-roboto">
                Partner with Us for Exceptional Quality and Design. Our B2B solutions are designed to help your business thrive by providing access to our extensive range of high-quality home decor products, competitive pricing, and reliable services. We welcome brick & mortar retailers, interior designers & architects with extensive discounts on bulk orders. With our in-house manufacturing facility in Moradabad, we are capable to do large corporate orders with customization solutions in all kinds of materials - Metal, Natural Solid Wood, Natural Marble, Mirror & Glass.
              </p>
            </div>

            {/* Right form with 60% width */}
            {/* Right form with 60% width */}
            <div className="w-3/5 bg-white p-6 shadow-lg rounded-lg">
              <h3 className="text-xl text-center font-bold mb-4">PARTNER WITH US</h3>
              <p className="mt-3 text-lg text-center text-gray-600">Tell about your bulk enquiry in the below form and our team will connect within 24 hours.</p>
