  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/plantersandvases/:productId" element={<PlantersAndVasesDesc />} />
        <Route path="/woodenCollection" element={<WoodenCollection />} />
        <Route path="/woodenCollection/:productId" element={<WoodenProductDesc />} />
        <Route path="/mercuryCollection" element={<MercuryCollection />} />
        <Route path="/mercuryCollection/:productId" element={<MercuryProductDesc />} />
        ...
        <Route path="/decor/objectDecor/:productId" element={<ObjectDecorProduct />} />
